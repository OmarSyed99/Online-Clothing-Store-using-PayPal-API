...
function handler(request, response) {
  ...
  io.on('connection', function(socket) {
    socket.on('redStoneData', function(data) {
      ...
      //to broadcast message to everyone including sender:
      io.emit('redStoneData', data) //broadcast to everyone including sender
    })
  })
  io.on('connection', function(socket) {
    socket.on('yellowStoneData', function(data) {
      //console.log('RECEIVED BOX DATA: ' + data)
      //to broadcast message to everyone including sender:
      io.emit('yellowStoneData', data) //broadcast to everyone including sender
    })
  })
  io.on('connection', function(socket) {
    socket.on('playerTurn', function(data) {
      //console.log('RECEIVED BOX DATA: ' + data)
      //to broadcast message to everyone including sender:
      io.emit('playerTurn', data) //broadcast to everyone including sender
    })
  })
  io.on('connection', function(socket) {
    socket.on('Collision', function(data) {
      //console.log('RECEIVED BOX DATA: ' + data)
      //to broadcast message to everyone including sender:
      io.emit('Collision', data) //broadcast to everyone including sender
    })
  })
  io.on('connection', function(socket) {
    socket.on('disable', function(data) {
      //console.log('RECEIVED BOX DATA: ' + data)
      //to broadcast message to everyone including sender:
      io.emit('disable', data) //broadcast to everyone including sender
    })
  })
